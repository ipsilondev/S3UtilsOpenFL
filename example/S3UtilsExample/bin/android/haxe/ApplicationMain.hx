...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Ipsilon Developments Inc.", "S3UtilsExample", "com.ipsilondev.S3UtilsExample", "1.0.0");
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (com.ipsilondev.Main)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (com.ipsilondev.Main, Reflect.field (com.ipsilondev.Main, "main"), []);
...
@:keep class DocumentClass extends com.ipsilondev.Main {}
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "S3UtilsExample", null, { width: 0, height: 0 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (com.ipsilondev.Main, []);
			}
