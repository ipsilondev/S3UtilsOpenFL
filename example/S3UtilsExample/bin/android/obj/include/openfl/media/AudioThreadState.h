...
#define INCLUDED_openfl_media_AudioThreadState
...
class HXCPP_CLASS_ATTRIBUTES  AudioThreadState_obj : public hx::Object{
	...
	public:
		...
		::cpp::vm::Mutex mutex;
		virtual Void add( ::openfl::media::SoundChannel channel);
		Dynamic add_dyn();

		virtual Void remove( ::openfl::media::SoundChannel channel);
		Dynamic remove_dyn();
...
#endif /* INCLUDED_openfl_media_AudioThreadState */ 
