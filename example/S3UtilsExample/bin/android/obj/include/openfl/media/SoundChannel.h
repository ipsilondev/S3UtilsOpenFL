...
HX_DECLARE_CLASS2(openfl,media,AudioThreadState)
...
class HXCPP_CLASS_ATTRIBUTES  SoundChannel_obj : public ::openfl::events::EventDispatcher_obj{
	...
	public:
		...
		Float leftPeak;
		Float rightPeak;
		::openfl::events::EventDispatcher __dataProvider;
		Dynamic __handle;
		::openfl::media::Sound __soundInstance;
		...
		static ::openfl::media::AudioThreadState __audioState;
		static bool __audioThreadIsIdle;
		static bool __audioThreadRunning;
		static ::openfl::media::SoundChannel createDynamic( Dynamic handle,::openfl::media::SoundTransform soundTransform,::openfl::events::EventDispatcher dataProvider);
