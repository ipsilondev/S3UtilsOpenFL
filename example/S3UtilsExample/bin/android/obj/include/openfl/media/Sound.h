...
class HXCPP_CLASS_ATTRIBUTES  Sound_obj : public ::openfl::events::EventDispatcher_obj{
	public:
		...
		Sound_obj();
		Void __construct(::openfl::net::URLRequest stream,::openfl::media::SoundLoaderContext context,hx::Null< bool >  __o_forcePlayAsMusic);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< Sound_obj > __new(::openfl::net::URLRequest stream,::openfl::media::SoundLoaderContext context,hx::Null< bool >  __o_forcePlayAsMusic);
		...
		Float length;
		::String url;
		::openfl::media::InternalAudioType __audioType;
		Dynamic __handle;
		bool __loading;
		bool __dynamicSound;
		...
		virtual Void load( ::openfl::net::URLRequest stream,::openfl::media::SoundLoaderContext context,hx::Null< bool >  forcePlayAsMusic);
		Dynamic load_dyn();

		virtual Void loadCompressedDataFromByteArray( ::openfl::utils::ByteArray bytes,int length,hx::Null< bool >  forcePlayAsMusic);
		Dynamic loadCompressedDataFromByteArray_dyn();

		virtual Void loadPCMFromByteArray( ::openfl::utils::ByteArray bytes,int samples,::String format,hx::Null< bool >  stereo,hx::Null< Float >  sampleRate);
		Dynamic loadPCMFromByteArray_dyn();

		virtual ::openfl::media::SoundChannel play( hx::Null< Float >  startTime,hx::Null< int >  loops,::openfl::media::SoundTransform soundTransform);
		Dynamic play_dyn();
