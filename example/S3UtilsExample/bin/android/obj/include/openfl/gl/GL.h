...
class HXCPP_CLASS_ATTRIBUTES  GL_obj : public hx::Object{
	...
	public:
		...
		static Void bindBitmapDataTexture( ::openfl::display::BitmapData texture);
		...
		static Void readPixels( int x,int y,int width,int height,int format,int type,::openfl::utils::ByteArray pixels);
