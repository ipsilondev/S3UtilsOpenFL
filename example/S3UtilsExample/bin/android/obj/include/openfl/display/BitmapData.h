...
class HXCPP_CLASS_ATTRIBUTES  BitmapData_obj : public hx::Object{
	...
	public:
		...
		virtual ::openfl::utils::ByteArray encode( ::String format,hx::Null< Float >  quality);
		Dynamic encode_dyn();

		virtual Void fillRect( ::openfl::geom::Rectangle rect,int color);
		Dynamic fillRect_dyn();

		virtual Void fillRectEx( ::openfl::geom::Rectangle rect,int color,hx::Null< int >  alpha);
		...
		virtual ::openfl::utils::ByteArray getPixels( ::openfl::geom::Rectangle rect);
		...
		virtual Void setPixels( ::openfl::geom::Rectangle rect,::openfl::utils::ByteArray pixels);
		Dynamic setPixels_dyn();

		virtual Void setVector( ::openfl::geom::Rectangle rect,Array< int > pixels);
		...
		virtual Void __loadFromBytes( ::openfl::utils::ByteArray bytes,::openfl::utils::ByteArray rawAlpha);
		...
		virtual ::openfl::geom::Rectangle get_rect( );
		...
		static ::openfl::utils::ByteArray getRGBAPixels( ::openfl::display::BitmapData bitmapData);
		static Dynamic getRGBAPixels_dyn();

		static ::openfl::display::BitmapData load( ::String filename,hx::Null< int >  format);
		static Dynamic load_dyn();

		static ::openfl::display::BitmapData loadFromBytes( ::openfl::utils::ByteArray bytes,::openfl::utils::ByteArray rawAlpha);
		static Dynamic loadFromBytes_dyn();

		static ::openfl::display::BitmapData loadFromHaxeBytes( ::haxe::io::Bytes bytes,::haxe::io::Bytes rawAlpha);
