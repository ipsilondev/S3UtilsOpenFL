...
HX_DECLARE_CLASS2(openfl,display,TouchInfo)
...
HX_DECLARE_CLASS2(openfl,system,ScreenMode)
namespace openfl{
namespace display{
...
class HXCPP_CLASS_ATTRIBUTES  Stage_obj : public ::openfl::display::DisplayObjectContainer_obj{
	...
	public:
		...
		virtual Void setScreenMode( ::openfl::system::ScreenMode mode);
		...
		virtual bool __checkInOuts( ::openfl::events::MouseEvent event,Array< ::Dynamic > stack,::openfl::display::TouchInfo touchInfo);
		...
		virtual Void __onTouch( Dynamic event,::String type,::openfl::display::TouchInfo touchInfo);
		...
		virtual ::openfl::display::StageQuality get_quality( );
		Dynamic get_quality_dyn();

		virtual ::openfl::display::StageQuality set_quality( ::openfl::display::StageQuality value);
