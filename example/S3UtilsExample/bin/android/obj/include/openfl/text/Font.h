...
class HXCPP_CLASS_ATTRIBUTES  Font_obj : public hx::Object{
	...
	public:
		...
		static hx::ObjectPtr< Font_obj > __new(::String __o_filename,::openfl::text::FontStyle style,::openfl::text::FontType type);
		...
		static Dynamic loadBytes( ::openfl::utils::ByteArray bytes);
