...
#define INCLUDED_openfl_utils_ByteArray
...
class HXCPP_CLASS_ATTRIBUTES  ByteArray_obj : public ::haxe::io::Bytes_obj{
	...
	public:
		...
		inline operator ::openfl::utils::IDataOutput_obj *()
			{ return new ::openfl::utils::IDataOutput_delegate_< ByteArray_obj >(this); }
		inline operator ::openfl::utils::IMemoryRange_obj *()
			{ return new ::openfl::utils::IMemoryRange_delegate_< ByteArray_obj >(this); }
		inline operator ::openfl::utils::IDataInput_obj *()
			{ return new ::openfl::utils::IDataInput_delegate_< ByteArray_obj >(this); }
		...
		virtual Void compress( ::openfl::utils::CompressionAlgorithm algorithm);
		...
		virtual ::openfl::utils::ByteArray getByteBuffer( );
		...
		virtual Void readBytes( ::openfl::utils::ByteArray data,hx::Null< int >  offset,hx::Null< int >  length);
		...
		virtual ::openfl::utils::ByteArray slice( int begin,Dynamic end);
		Dynamic slice_dyn();

		virtual Void uncompress( ::openfl::utils::CompressionAlgorithm algorithm);
		...
		static ::openfl::utils::ByteArray fromBytes( ::haxe::io::Bytes bytes);
		static Dynamic fromBytes_dyn();

		static ::openfl::utils::ByteArray readFile( ::String path);
...
#endif /* INCLUDED_openfl_utils_ByteArray */ 
