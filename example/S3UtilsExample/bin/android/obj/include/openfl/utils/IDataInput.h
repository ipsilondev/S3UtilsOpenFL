...
virtual Void readBytes( ::openfl::utils::ByteArray data,hx::Null< int >  offset,hx::Null< int >  length)=0;
...
#define DELEGATE_openfl_utils_IDataInput \
...
virtual Void readBytes( ::openfl::utils::ByteArray data,hx::Null< int >  offset,hx::Null< int >  length) { return mDelegate->readBytes(data,offset,length);}  \
...
class IDataInput_delegate_ : public IDataInput_obj
{
	...
	public:
		...
		DELEGATE_openfl_utils_IDataInput
};
