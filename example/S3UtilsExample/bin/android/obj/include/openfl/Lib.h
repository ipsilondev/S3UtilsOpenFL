...
class HXCPP_CLASS_ATTRIBUTES  Lib_obj : public hx::Object{
	...
	public:
		...
		static ::openfl::display::MovieClip __current;
		...
		static ::openfl::display::Stage __stage;
		...
		static Void create( Dynamic onLoaded,int width,int height,hx::Null< Float >  frameRate,hx::Null< int >  color,hx::Null< int >  flags,::String title,::openfl::display::BitmapData icon,::Class stageClass);
		...
		static Void getURL( ::openfl::net::URLRequest url,::String target);
		...
		static Void __setCurrentStage( ::openfl::display::Stage stage);
		...
		static Dynamic lime_post_ui_callback;
		static Dynamic &lime_post_ui_callback_dyn() { return lime_post_ui_callback;}
