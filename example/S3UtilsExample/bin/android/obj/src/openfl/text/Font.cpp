...
Void Font_obj::__construct(::String __o_filename,::openfl::text::FontStyle style,::openfl::text::FontType type)
{
HX_STACK_FRAME("openfl.text.Font","new",0xe13d5ce4,"openfl.text.Font.new","openfl/text/Font.hx",24,0x076bbaac)
HX_STACK_THIS(this)
...
::String filename = __o_filename.Default(HX_CSTRING(""));
{
	...
	if (((filename == HX_CSTRING("")))){
		...
		if ((::Reflect_obj::hasField(fontClass,HX_CSTRING("resourceName")))){
			...
			HX_STACK_LINE(30)
			::openfl::utils::ByteArray bytes = ::openfl::utils::ByteArray_obj::fromBytes(_g1);		HX_STACK_VAR(bytes,"bytes");
			HX_STACK_LINE(31)
			Dynamic details = ::openfl::text::Font_obj::loadBytes(bytes);		HX_STACK_VAR(details,"details");
			HX_STACK_LINE(32)
			...
			if (((bool(details->__Field(HX_CSTRING("is_bold"),true)) && bool(details->__Field(HX_CSTRING("is_italic"),true))))){
				HX_STACK_LINE(36)
				this->fontStyle = ::openfl::text::FontStyle_obj::BOLD_ITALIC;
			}
			else{
				HX_STACK_LINE(38)
				if ((details->__Field(HX_CSTRING("is_bold"),true))){
					HX_STACK_LINE(40)
					this->fontStyle = ::openfl::text::FontStyle_obj::BOLD;
				}
				else{
					HX_STACK_LINE(42)
					if ((details->__Field(HX_CSTRING("is_italic"),true))){
						HX_STACK_LINE(44)
						this->fontStyle = ::openfl::text::FontStyle_obj::ITALIC;
					}
					else{
						HX_STACK_LINE(48)
						this->fontStyle = ::openfl::text::FontStyle_obj::REGULAR;
					}
				}
			}
			HX_STACK_LINE(52)
			this->fontType = ::openfl::text::FontType_obj::EMBEDDED;
		}
		else{
		}
	}
...
hx::ObjectPtr< Font_obj > Font_obj::__new(::String __o_filename,::openfl::text::FontStyle style,::openfl::text::FontType type)
...
::String Font_obj::toString( ){
	HX_STACK_FRAME("openfl.text.Font","toString",0x288565a8,"openfl.text.Font.toString","openfl/text/Font.hx",132,0x076bbaac)
	HX_STACK_THIS(this)
	HX_STACK_LINE(134)
...
bool enumerateDeviceFonts = __o_enumerateDeviceFonts.Default(false);
	HX_STACK_FRAME("openfl.text.Font","enumerateFonts",0x792ac3fc,"openfl.text.Font.enumerateFonts","openfl/text/Font.hx",74,0x076bbaac)
	HX_STACK_ARG(enumerateDeviceFonts,"enumerateDeviceFonts")
{
		HX_STACK_LINE(76)
		Array< ::Dynamic > result = ::openfl::text::Font_obj::__registeredFonts->copy();		HX_STACK_VAR(result,"result");
		HX_STACK_LINE(78)
		if ((enumerateDeviceFonts)){
			HX_STACK_LINE(80)
			if (((::openfl::text::Font_obj::__deviceFonts == null()))){
				HX_STACK_LINE(82)
				Array< ::Dynamic > _g = Array_obj< ::Dynamic >::__new();		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(82)
				::openfl::text::Font_obj::__deviceFonts = _g;
				HX_STACK_LINE(83)
				Array< ::Dynamic > styles = Array_obj< ::Dynamic >::__new().Add(Array_obj< ::Dynamic >::__new().Add(::openfl::text::FontStyle_obj::BOLD).Add(::openfl::text::FontStyle_obj::BOLD_ITALIC).Add(::openfl::text::FontStyle_obj::ITALIC).Add(::openfl::text::FontStyle_obj::REGULAR));		HX_STACK_VAR(styles,"styles");

				HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_3_1,Array< ::Dynamic >,styles)
				Void run(::String name,int style){
					HX_STACK_FRAME("*","_Function_3_1",0x520271b9,"*._Function_3_1","openfl/text/Font.hx",84,0x076bbaac)
					HX_STACK_ARG(name,"name")
					HX_STACK_ARG(style,"style")
					{
						HX_STACK_LINE(84)
						::openfl::text::Font_obj::__deviceFonts->push(::openfl::text::Font_obj::__new(name,styles->__get((int)0).StaticCast< Array< ::Dynamic > >()->__get(style).StaticCast< ::openfl::text::FontStyle >(),::openfl::text::FontType_obj::DEVICE));
					}
					return null();
				}
				...
				HX_STACK_LINE(84)
				::openfl::text::Font_obj::lime_font_iterate_device_fonts( Dynamic(new _Function_3_1(styles)));
			}
			HX_STACK_LINE(88)
			Array< ::Dynamic > _g1 = result->concat(::openfl::text::Font_obj::__deviceFonts);		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(88)
			result = _g1;
		}
		HX_STACK_LINE(92)
...
Dynamic Font_obj::load( ::String filename){
	HX_STACK_FRAME("openfl.text.Font","load",0x33290122,"openfl.text.Font.load","openfl/text/Font.hx",97,0x076bbaac)
	HX_STACK_ARG(filename,"filename")
	HX_STACK_LINE(99)
	Dynamic result = ::openfl::text::Font_obj::freetype_import_font(filename,null(),(int)20480,null());		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(100)
	return result;
}
...
Dynamic Font_obj::loadBytes( ::openfl::utils::ByteArray bytes){
	HX_STACK_FRAME("openfl.text.Font","loadBytes",0xfc7b1be9,"openfl.text.Font.loadBytes","openfl/text/Font.hx",105,0x076bbaac)
	HX_STACK_ARG(bytes,"bytes")
	HX_STACK_LINE(107)
	Dynamic result = ::openfl::text::Font_obj::freetype_import_font(HX_CSTRING(""),null(),(int)20480,bytes);		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(108)
	return result;
}
...
{
		HX_STACK_FRAME("openfl.text.Font","registerFont",0xd99a60ce,"openfl.text.Font.registerFont","openfl/text/Font.hx",113,0x076bbaac)
		HX_STACK_ARG(font,"font")
		HX_STACK_LINE(115)
		::openfl::text::Font instance = ::Type_obj::createInstance(font,Dynamic( Array_obj<Dynamic>::__new().Add(HX_CSTRING("")).Add(null()).Add(null())));		HX_STACK_VAR(instance,"instance");
		HX_STACK_LINE(117)
		if (((instance != null()))){
			HX_STACK_LINE(119)
			if ((::Reflect_obj::hasField(font,HX_CSTRING("resourceName")))){
				...
				::haxe::io::Bytes _g1 = ::haxe::Resource_obj::getBytes(_g);		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(121)
				::openfl::utils::ByteArray _g2 = ::openfl::utils::ByteArray_obj::fromBytes(_g1);		HX_STACK_VAR(_g2,"_g2");
				HX_STACK_LINE(121)
				::openfl::text::Font_obj::lime_font_register_font(instance->fontName,_g2);
			}
			HX_STACK_LINE(125)
...
void Font_obj::__boot()
{
	...
	freetype_import_font= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("freetype_import_font"),(int)4);
	lime_font_register_font= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_font_register_font"),(int)2);
	lime_font_iterate_device_fonts= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_font_iterate_device_fonts"),(int)1);
}
