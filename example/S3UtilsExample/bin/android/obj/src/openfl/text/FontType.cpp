...
::openfl::text::FontType FontType_obj::DEVICE;

::openfl::text::FontType FontType_obj::EMBEDDED;

::openfl::text::FontType FontType_obj::EMBEDDED_CFF;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl.text.FontType"), hx::TCanCast< FontType_obj >,sStaticFields,sMemberFields,
