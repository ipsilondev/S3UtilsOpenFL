...
::openfl::text::TextFieldAutoSize TextFieldAutoSize_obj::CENTER;

::openfl::text::TextFieldAutoSize TextFieldAutoSize_obj::LEFT;

::openfl::text::TextFieldAutoSize TextFieldAutoSize_obj::NONE;

::openfl::text::TextFieldAutoSize TextFieldAutoSize_obj::RIGHT;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl.text.TextFieldAutoSize"), hx::TCanCast< TextFieldAutoSize_obj >,sStaticFields,sMemberFields,
