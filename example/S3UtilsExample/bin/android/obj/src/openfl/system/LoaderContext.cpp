...
Void LoaderContext_obj::__construct(hx::Null< bool >  __o_checkPolicyFile,::openfl::system::ApplicationDomain applicationDomain,::openfl::system::SecurityDomain securityDomain)
{
...
hx::ObjectPtr< LoaderContext_obj > LoaderContext_obj::__new(hx::Null< bool >  __o_checkPolicyFile,::openfl::system::ApplicationDomain applicationDomain,::openfl::system::SecurityDomain securityDomain)
...
Dynamic LoaderContext_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 14:
		if (HX_FIELD_EQ(inName,"securityDomain") ) { securityDomain=inValue.Cast< ::openfl::system::SecurityDomain >(); return inValue; }
		break;
	case 15:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::system::ApplicationDomain*/ ,(int)offsetof(LoaderContext_obj,applicationDomain),HX_CSTRING("applicationDomain")},
	{hx::fsBool,(int)offsetof(LoaderContext_obj,checkPolicyFile),HX_CSTRING("checkPolicyFile")},
	{hx::fsObject /*::openfl::system::SecurityDomain*/ ,(int)offsetof(LoaderContext_obj,securityDomain),HX_CSTRING("securityDomain")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl.system.LoaderContext"), hx::TCanCast< LoaderContext_obj> ,sStaticFields,sMemberFields,
