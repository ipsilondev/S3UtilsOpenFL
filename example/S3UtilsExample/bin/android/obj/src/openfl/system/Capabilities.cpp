...
::String Capabilities_obj::get_language( ){
	HX_STACK_FRAME("openfl.system.Capabilities","get_language",0xce1cefd8,"openfl.system.Capabilities.get_language","openfl/system/Capabilities.hx",25,0xabe25da7)
	HX_STACK_LINE(27)
	::String locale = ::openfl::system::Capabilities_obj::lime_capabilities_get_language();		HX_STACK_VAR(locale,"locale");
	HX_STACK_LINE(29)
...
Float Capabilities_obj::get_pixelAspectRatio( ){
	HX_STACK_FRAME("openfl.system.Capabilities","get_pixelAspectRatio",0xa176c2ad,"openfl.system.Capabilities.get_pixelAspectRatio","openfl/system/Capabilities.hx",71,0xabe25da7)
	HX_STACK_LINE(71)
	return ::openfl::system::Capabilities_obj::lime_capabilities_get_pixel_aspect_ratio();
}
...
Float Capabilities_obj::get_screenDPI( ){
	HX_STACK_FRAME("openfl.system.Capabilities","get_screenDPI",0x6de6afd1,"openfl.system.Capabilities.get_screenDPI","openfl/system/Capabilities.hx",72,0xabe25da7)
	HX_STACK_LINE(72)
	return ::openfl::system::Capabilities_obj::lime_capabilities_get_screen_dpi();
}
...
Array< ::Dynamic > Capabilities_obj::get_screenResolutions( ){
	HX_STACK_FRAME("openfl.system.Capabilities","get_screenResolutions",0x9f8b6e3b,"openfl.system.Capabilities.get_screenResolutions","openfl/system/Capabilities.hx",75,0xabe25da7)
	HX_STACK_LINE(77)
	Array< int > res = ::openfl::system::Capabilities_obj::lime_capabilities_get_screen_resolutions();		HX_STACK_VAR(res,"res");
	HX_STACK_LINE(79)
	if (((res == null()))){
		HX_STACK_LINE(81)
...
Float Capabilities_obj::get_screenResolutionX( ){
	HX_STACK_FRAME("openfl.system.Capabilities","get_screenResolutionX",0x9f8b6e20,"openfl.system.Capabilities.get_screenResolutionX","openfl/system/Capabilities.hx",98,0xabe25da7)
	HX_STACK_LINE(98)
	return ::openfl::system::Capabilities_obj::lime_capabilities_get_screen_resolution_x();
}
...
Float Capabilities_obj::get_screenResolutionY( ){
	HX_STACK_FRAME("openfl.system.Capabilities","get_screenResolutionY",0x9f8b6e21,"openfl.system.Capabilities.get_screenResolutionY","openfl/system/Capabilities.hx",99,0xabe25da7)
	HX_STACK_LINE(99)
	return ::openfl::system::Capabilities_obj::lime_capabilities_get_screen_resolution_y();
}
...
Array< ::Dynamic > Capabilities_obj::get_screenModes( ){
	HX_STACK_FRAME("openfl.system.Capabilities","get_screenModes",0xfbfcb124,"openfl.system.Capabilities.get_screenModes","openfl/system/Capabilities.hx",101,0xabe25da7)
	HX_STACK_LINE(102)
	Array< int > modes = ::openfl::system::Capabilities_obj::lime_capabilities_get_screen_modes();		HX_STACK_VAR(modes,"modes");
	HX_STACK_LINE(103)
	Array< ::Dynamic > out = Array_obj< ::Dynamic >::__new();		HX_STACK_VAR(out,"out");
	HX_STACK_LINE(105)
	if (((modes == null()))){
	...
	HX_STACK_LINE(109)
	{
		...
		while((true)){
			...
			int c = (_g1)++;		HX_STACK_VAR(c,"c");
			HX_STACK_LINE(110)
			::openfl::system::ScreenMode mode = ::openfl::system::ScreenMode_obj::__new();		HX_STACK_VAR(mode,"mode");
			HX_STACK_LINE(111)
			...
			HX_STACK_LINE(114)
			::openfl::system::PixelFormat _g2 = ::Type_obj::createEnumIndex(hx::ClassOf< ::openfl::system::PixelFormat >(),modes->__get(((c * (int)4) + (int)3)),null());		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(114)
			mode->format = _g2;
			HX_STACK_LINE(115)
			out->push(mode);
...
{
	lime_capabilities_get_pixel_aspect_ratio= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_capabilities_get_pixel_aspect_ratio"),(int)0);
	lime_capabilities_get_screen_dpi= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_capabilities_get_screen_dpi"),(int)0);
	lime_capabilities_get_screen_resolution_x= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_capabilities_get_screen_resolution_x"),(int)0);
	lime_capabilities_get_screen_resolution_y= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_capabilities_get_screen_resolution_y"),(int)0);
	lime_capabilities_get_screen_resolutions= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_capabilities_get_screen_resolutions"),(int)0);
	lime_capabilities_get_screen_modes= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_capabilities_get_screen_modes"),(int)0);
	lime_capabilities_get_language= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_capabilities_get_language"),(int)0);
}
