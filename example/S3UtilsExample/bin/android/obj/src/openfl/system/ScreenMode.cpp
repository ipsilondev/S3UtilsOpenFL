...
{
HX_STACK_FRAME("openfl.system.ScreenMode","new",0xbb1968c2,"openfl.system.ScreenMode.new","openfl/system/ScreenMode.hx",9,0xa03c1ece)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(10)
	this->width = (int)-1;
...
Dynamic ScreenMode_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 5:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"format") ) { format=inValue.Cast< ::openfl::system::PixelFormat >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::system::PixelFormat*/ ,(int)offsetof(ScreenMode_obj,format),HX_CSTRING("format")},
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl.system.ScreenMode"), hx::TCanCast< ScreenMode_obj> ,sStaticFields,sMemberFields,
