...
{
HX_STACK_FRAME("openfl.net.URLRequest","new",0xe13767c1,"openfl.net.URLRequest.new","openfl/net/URLRequest.hx",32,0xe997cd0d)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl.net.URLRequest","basicAuth",0x59f0fb57,"openfl.net.URLRequest.basicAuth","openfl/net/URLRequest.hx",53,0xe997cd0d)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl.net.URLRequest","digestAuth",0xbd1f048b,"openfl.net.URLRequest.digestAuth","openfl/net/URLRequest.hx",61,0xe997cd0d)
		HX_STACK_THIS(this)
		HX_STACK_ARG(user,"user")
		HX_STACK_ARG(password,"password")
		HX_STACK_LINE(63)
...
{
		HX_STACK_FRAME("openfl.net.URLRequest","__prepare",0xd0fcb888,"openfl.net.URLRequest.__prepare","openfl/net/URLRequest.hx",71,0xe997cd0d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(71)
		if (((this->data == null()))){
			HX_STACK_LINE(73)
			::openfl::utils::ByteArray _g = ::openfl::utils::ByteArray_obj::__new(null());		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(73)
			this->__bytes = _g;
		}
		else{
			HX_STACK_LINE(75)
			if ((::Std_obj::is(this->data,hx::ClassOf< ::openfl::utils::ByteArray >()))){
				HX_STACK_LINE(77)
				...
				if ((::Std_obj::is(this->data,hx::ClassOf< ::openfl::net::URLVariables >()))){
					...
					if ((::Std_obj::is(this->data,hx::ClassOf< ::String >()))){
						...
						HX_STACK_LINE(89)
						::openfl::utils::ByteArray _g2 = ::openfl::utils::ByteArray_obj::__new(null());		HX_STACK_VAR(_g2,"_g2");
						HX_STACK_LINE(89)
						this->__bytes = _g2;
						HX_STACK_LINE(90)
						this->__bytes->writeUTFBytes(str);
						...
						if ((::Std_obj::is(this->data,hx::ClassOf< ::Dynamic >()))){
							...
							::String str = vars->toString();		HX_STACK_VAR(str,"str");
							HX_STACK_LINE(103)
							::openfl::utils::ByteArray _g3 = ::openfl::utils::ByteArray_obj::__new(null());		HX_STACK_VAR(_g3,"_g3");
							HX_STACK_LINE(103)
							this->__bytes = _g3;
							HX_STACK_LINE(104)
							this->__bytes->writeUTFBytes(str);
...
Dynamic URLRequest_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"__bytes") ) { __bytes=inValue.Cast< ::openfl::utils::ByteArray >(); return inValue; }
		break;
	case 8:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::utils::ByteArray*/ ,(int)offsetof(URLRequest_obj,__bytes),HX_CSTRING("__bytes")},
	{ hx::fsUnknown, 0, null()}
};
#endif
