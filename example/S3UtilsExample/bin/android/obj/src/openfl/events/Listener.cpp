...
{
HX_STACK_FRAME("openfl.events.Listener","new",0xa4c65a1d,"openfl.events.Listener.new","openfl/events/EventDispatcher.hx",256,0xe2270714)
HX_STACK_THIS(this)
...
HX_STACK_ARG(priority,"priority")
{
	...
	HX_STACK_LINE(261)
	int _g = (::openfl::events::Listener_obj::__id)++;		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(261)
	this->id = _g;
}
;
...
Void Listener_obj::dispatchEvent( ::openfl::events::Event event){
{
		HX_STACK_FRAME("openfl.events.Listener","dispatchEvent",0x58f1befd,"openfl.events.Listener.dispatchEvent","openfl/events/EventDispatcher.hx",268,0xe2270714)
		HX_STACK_THIS(this)
...
bool Listener_obj::is( Dynamic listener,bool useCapture){
	HX_STACK_FRAME("openfl.events.Listener","is",0x4ff318cd,"openfl.events.Listener.is","openfl/events/EventDispatcher.hx",273,0xe2270714)
	HX_STACK_THIS(this)
	HX_STACK_ARG(listener,"listener")
	HX_STACK_ARG(useCapture,"useCapture")
	HX_STACK_LINE(275)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl.events.Listener"), hx::TCanCast< Listener_obj> ,sStaticFields,sMemberFields,
