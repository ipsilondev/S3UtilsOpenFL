...
{
HX_STACK_FRAME("openfl.events.KeyboardEvent","new",0xa9982e4e,"openfl.events.KeyboardEvent.new","openfl/events/KeyboardEvent.hx",19,0xce5f4702)
HX_STACK_THIS(this)
...
::openfl::events::Event KeyboardEvent_obj::clone( ){
	HX_STACK_FRAME("openfl.events.KeyboardEvent","clone",0x11ed48cb,"openfl.events.KeyboardEvent.clone","openfl/events/KeyboardEvent.hx",36,0xce5f4702)
	HX_STACK_THIS(this)
	HX_STACK_LINE(38)
	...
	HX_STACK_LINE(38)
	return ::openfl::events::KeyboardEvent_obj::__new(_g,_g1,_g2,this->charCode,this->keyCode,this->keyLocation,this->ctrlKey,this->altKey,this->shiftKey,this->controlKey,this->commandKey);
}


::String KeyboardEvent_obj::toString( ){
	HX_STACK_FRAME("openfl.events.KeyboardEvent","toString",0xd22933fe,"openfl.events.KeyboardEvent.toString","openfl/events/KeyboardEvent.hx",43,0xce5f4702)
	HX_STACK_THIS(this)
	HX_STACK_LINE(45)
	::String _g = this->get_type();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(45)
