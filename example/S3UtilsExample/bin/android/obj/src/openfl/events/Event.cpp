...
{
HX_STACK_FRAME("openfl.events.Event","new",0x2731c6f5,"openfl.events.Event.new","openfl/events/Event.hx",51,0x7220a03b)
HX_STACK_THIS(this)
...
::openfl::events::Event Event_obj::clone( ){
	HX_STACK_FRAME("openfl.events.Event","clone",0x5b9b9932,"openfl.events.Event.clone","openfl/events/Event.hx",65,0x7220a03b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(67)
	...
	HX_STACK_LINE(67)
	return ::openfl::events::Event_obj::__new(_g,_g1,_g2);
}
...
bool Event_obj::isDefaultPrevented( ){
	HX_STACK_FRAME("openfl.events.Event","isDefaultPrevented",0x5475e94b,"openfl.events.Event.isDefaultPrevented","openfl/events/Event.hx",74,0x7220a03b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(74)
...
{
		HX_STACK_FRAME("openfl.events.Event","stopImmediatePropagation",0xa67252c8,"openfl.events.Event.stopImmediatePropagation","openfl/events/Event.hx",81,0x7220a03b)
		HX_STACK_THIS(this)
		HX_STACK_LINE(81)
...
{
		HX_STACK_FRAME("openfl.events.Event","stopPropagation",0xb07183ff,"openfl.events.Event.stopPropagation","openfl/events/Event.hx",93,0x7220a03b)
		HX_STACK_THIS(this)
		HX_STACK_LINE(93)
		if ((this->get_cancelable())){
			HX_STACK_LINE(95)
...
::String Event_obj::toString( ){
	HX_STACK_FRAME("openfl.events.Event","toString",0x6e61ddf7,"openfl.events.Event.toString","openfl/events/Event.hx",102,0x7220a03b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(104)
	::String _g = this->get_type();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(104)
...
bool Event_obj::__getIsCancelled( ){
	HX_STACK_FRAME("openfl.events.Event","__getIsCancelled",0xac94ebbc,"openfl.events.Event.__getIsCancelled","openfl/events/Event.hx",111,0x7220a03b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(111)
...
bool Event_obj::__getIsCancelledNow( ){
	HX_STACK_FRAME("openfl.events.Event","__getIsCancelledNow",0x398fa2ba,"openfl.events.Event.__getIsCancelledNow","openfl/events/Event.hx",118,0x7220a03b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(118)
...
{
		HX_STACK_FRAME("openfl.events.Event","__setPhase",0x561f3a64,"openfl.events.Event.__setPhase","openfl/events/Event.hx",125,0x7220a03b)
		HX_STACK_THIS(this)
...
bool Event_obj::get_bubbles( ){
	HX_STACK_FRAME("openfl.events.Event","get_bubbles",0x74972f13,"openfl.events.Event.get_bubbles","openfl/events/Event.hx",137,0x7220a03b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(137)
...
bool Event_obj::get_cancelable( ){
	HX_STACK_FRAME("openfl.events.Event","get_cancelable",0xae73bfe8,"openfl.events.Event.get_cancelable","openfl/events/Event.hx",138,0x7220a03b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(138)
...
Dynamic Event_obj::get_currentTarget( ){
	HX_STACK_FRAME("openfl.events.Event","get_currentTarget",0x824df116,"openfl.events.Event.get_currentTarget","openfl/events/Event.hx",139,0x7220a03b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(139)
...
Dynamic Event_obj::set_currentTarget( Dynamic value){
	HX_STACK_FRAME("openfl.events.Event","set_currentTarget",0xa5bbc922,"openfl.events.Event.set_currentTarget","openfl/events/Event.hx",140,0x7220a03b)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(140)
...
::openfl::events::EventPhase Event_obj::get_eventPhase( ){
	HX_STACK_FRAME("openfl.events.Event","get_eventPhase",0x283e5195,"openfl.events.Event.get_eventPhase","openfl/events/Event.hx",141,0x7220a03b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(141)
...
Dynamic Event_obj::get_target( ){
	HX_STACK_FRAME("openfl.events.Event","get_target",0x5a3d9925,"openfl.events.Event.get_target","openfl/events/Event.hx",142,0x7220a03b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(142)
...
Dynamic Event_obj::set_target( Dynamic value){
	HX_STACK_FRAME("openfl.events.Event","set_target",0x5dbb3799,"openfl.events.Event.set_target","openfl/events/Event.hx",143,0x7220a03b)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(143)
...
::String Event_obj::get_type( ){
	HX_STACK_FRAME("openfl.events.Event","get_type",0x02b6bb8e,"openfl.events.Event.get_type","openfl/events/Event.hx",144,0x7220a03b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(144)
	return this->__type;
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl.events.Event"), hx::TCanCast< Event_obj> ,sStaticFields,sMemberFields,
