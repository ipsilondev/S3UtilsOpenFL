...
{
HX_STACK_FRAME("openfl.events.MouseEvent","new",0x5c6da59e,"openfl.events.MouseEvent.new","openfl/events/MouseEvent.hx",47,0xd3783172)
HX_STACK_THIS(this)
...
::openfl::events::Event MouseEvent_obj::clone( ){
	HX_STACK_FRAME("openfl.events.MouseEvent","clone",0x3e8b341b,"openfl.events.MouseEvent.clone","openfl/events/MouseEvent.hx",65,0xd3783172)
	HX_STACK_THIS(this)
	HX_STACK_LINE(67)
	...
	HX_STACK_LINE(67)
	return ::openfl::events::MouseEvent_obj::__new(_g,_g1,_g2,this->localX,this->localY,this->relatedObject,this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);
}


::String MouseEvent_obj::toString( ){
	HX_STACK_FRAME("openfl.events.MouseEvent","toString",0x2fb13aae,"openfl.events.MouseEvent.toString","openfl/events/MouseEvent.hx",72,0xd3783172)
	HX_STACK_THIS(this)
	HX_STACK_LINE(74)
	::String _g = this->get_type();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(74)
...
{
		HX_STACK_FRAME("openfl.events.MouseEvent","updateAfterEvent",0xc76737c9,"openfl.events.MouseEvent.updateAfterEvent","openfl/events/MouseEvent.hx",79,0xd3783172)
		HX_STACK_THIS(this)
	}
return null();
}
...
::openfl::events::MouseEvent MouseEvent_obj::__createSimilar( ::String type,::openfl::display::InteractiveObject related,::openfl::display::InteractiveObject target){
	HX_STACK_FRAME("openfl.events.MouseEvent","__createSimilar",0xcc9cf1ad,"openfl.events.MouseEvent.__createSimilar","openfl/events/MouseEvent.hx",98,0xd3783172)
	HX_STACK_THIS(this)
	HX_STACK_ARG(type,"type")
	...
	HX_STACK_LINE(100)
	::openfl::events::MouseEvent mouseEvent = ::openfl::events::MouseEvent_obj::__new(type,_g,_g1,this->localX,this->localY,(  (((related == null()))) ? ::openfl::display::InteractiveObject(this->relatedObject) : ::openfl::display::InteractiveObject(related) ),this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);		HX_STACK_VAR(mouseEvent,"mouseEvent");
	HX_STACK_LINE(102)
...
::openfl::events::MouseEvent MouseEvent_obj::__create( ::String type,Dynamic event,::openfl::geom::Point local,::openfl::display::InteractiveObject target){
	HX_STACK_FRAME("openfl.events.MouseEvent","__create",0x1b813c1e,"openfl.events.MouseEvent.__create","openfl/events/MouseEvent.hx",86,0xd3783172)
	HX_STACK_ARG(type,"type")
	...
	HX_STACK_LINE(89)
	::openfl::events::MouseEvent mouseEvent = ::openfl::events::MouseEvent_obj::__new(type,true,true,local->x,local->y,null(),(((int(flags) & int(::openfl::events::MouseEvent_obj::efCtrlDown))) != (int)0),(((int(flags) & int(::openfl::events::MouseEvent_obj::efAltDown))) != (int)0),(((int(flags) & int(::openfl::events::MouseEvent_obj::efShiftDown))) != (int)0),(((int(flags) & int(::openfl::events::MouseEvent_obj::efLeftDown))) != (int)0),(int)0,null(),(int)0);		HX_STACK_VAR(mouseEvent,"mouseEvent");
	HX_STACK_LINE(90)
