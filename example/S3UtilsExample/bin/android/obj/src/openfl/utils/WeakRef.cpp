...
{
	lime_weak_ref_create= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_weak_ref_create"),(int)2);
	lime_weak_ref_get= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_weak_ref_get"),(int)1);
}
