...
::openfl::utils::CompressionAlgorithm CompressionAlgorithm_obj::DEFLATE;

::openfl::utils::CompressionAlgorithm CompressionAlgorithm_obj::GZIP;

::openfl::utils::CompressionAlgorithm CompressionAlgorithm_obj::LZMA;

::openfl::utils::CompressionAlgorithm CompressionAlgorithm_obj::ZLIB;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl.utils.CompressionAlgorithm"), hx::TCanCast< CompressionAlgorithm_obj >,sStaticFields,sMemberFields,
