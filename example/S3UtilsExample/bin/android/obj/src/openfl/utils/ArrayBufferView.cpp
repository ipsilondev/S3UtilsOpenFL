...
int byteOffset = __o_byteOffset.Default(0);
{
	...
	if ((::Std_obj::is(lengthOrBuffer,hx::ClassOf< ::Int >()))){
		...
		HX_STACK_LINE(30)
		::openfl::utils::ByteArray _g2 = ::openfl::utils::ByteArray_obj::__new(_g1);		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(30)
		this->buffer = _g2;
	}
	else{
...
::openfl::utils::ByteArray ArrayBufferView_obj::getByteBuffer( ){
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::utils::ByteArray*/ ,(int)offsetof(ArrayBufferView_obj,buffer),HX_CSTRING("buffer")},
