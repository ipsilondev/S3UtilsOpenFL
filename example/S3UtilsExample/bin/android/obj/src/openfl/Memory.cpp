...
int Memory_obj::getByte( int addr){
	HX_STACK_FRAME("openfl.Memory","getByte",0xd720eb8f,"openfl.Memory.getByte","openfl/Memory.hx",217,0x3e66e7be)
	HX_STACK_ARG(addr,"addr")
	HX_STACK_LINE(219)
	if (((bool((addr < (int)0)) || bool((addr >= ::openfl::Memory_obj::len))))){
		HX_STACK_LINE(219)
...
Float Memory_obj::getDouble( int addr){
	HX_STACK_FRAME("openfl.Memory","getDouble",0x9d3a6758,"openfl.Memory.getDouble","openfl/Memory.hx",225,0x3e66e7be)
	HX_STACK_ARG(addr,"addr")
	HX_STACK_LINE(227)
	if (((bool((addr < (int)0)) || bool((addr >= ::openfl::Memory_obj::len))))){
		HX_STACK_LINE(227)
...
Float Memory_obj::getFloat( int addr){
	HX_STACK_FRAME("openfl.Memory","getFloat",0xaaabef35,"openfl.Memory.getFloat","openfl/Memory.hx",233,0x3e66e7be)
	HX_STACK_ARG(addr,"addr")
	HX_STACK_LINE(235)
	if (((bool((addr < (int)0)) || bool((addr >= ::openfl::Memory_obj::len))))){
		HX_STACK_LINE(235)
...
int Memory_obj::getI32( int addr){
	HX_STACK_FRAME("openfl.Memory","getI32",0x92c73aa1,"openfl.Memory.getI32","openfl/Memory.hx",241,0x3e66e7be)
	HX_STACK_ARG(addr,"addr")
	HX_STACK_LINE(243)
	if (((bool((addr < (int)0)) || bool((addr >= ::openfl::Memory_obj::len))))){
		HX_STACK_LINE(243)
...
int Memory_obj::getUI16( int addr){
	HX_STACK_FRAME("openfl.Memory","getUI16",0xe38b52a0,"openfl.Memory.getUI16","openfl/Memory.hx",249,0x3e66e7be)
	HX_STACK_ARG(addr,"addr")
	HX_STACK_LINE(251)
	if (((bool((addr < (int)0)) || bool((addr >= ::openfl::Memory_obj::len))))){
		HX_STACK_LINE(251)
...
{
		HX_STACK_FRAME("openfl.Memory","setByte",0xca227c9b,"openfl.Memory.setByte","openfl/Memory.hx",257,0x3e66e7be)
		HX_STACK_ARG(addr,"addr")
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(259)
		if (((bool((addr < (int)0)) || bool((addr >= ::openfl::Memory_obj::len))))){
...
{
		HX_STACK_FRAME("openfl.Memory","setDouble",0x808b5364,"openfl.Memory.setDouble","openfl/Memory.hx",265,0x3e66e7be)
		HX_STACK_ARG(addr,"addr")
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(267)
		if (((bool((addr < (int)0)) || bool((addr >= ::openfl::Memory_obj::len))))){
...
{
		HX_STACK_FRAME("openfl.Memory","setFloat",0x590948a9,"openfl.Memory.setFloat","openfl/Memory.hx",273,0x3e66e7be)
		HX_STACK_ARG(addr,"addr")
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(275)
		if (((bool((addr < (int)0)) || bool((addr >= ::openfl::Memory_obj::len))))){
...
{
		HX_STACK_FRAME("openfl.Memory","setI16",0x5f0f8d5b,"openfl.Memory.setI16","openfl/Memory.hx",281,0x3e66e7be)
		HX_STACK_ARG(addr,"addr")
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(283)
		if (((bool((addr < (int)0)) || bool((addr >= ::openfl::Memory_obj::len))))){
...
{
		HX_STACK_FRAME("openfl.Memory","setI32",0x5f0f8f15,"openfl.Memory.setI32","openfl/Memory.hx",289,0x3e66e7be)
		HX_STACK_ARG(addr,"addr")
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(291)
		if (((bool((addr < (int)0)) || bool((addr >= ::openfl::Memory_obj::len))))){
