...
::openfl::display::StageDisplayState StageDisplayState_obj::FULL_SCREEN;

::openfl::display::StageDisplayState StageDisplayState_obj::FULL_SCREEN_INTERACTIVE;

::openfl::display::StageDisplayState StageDisplayState_obj::NORMAL;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl.display.StageDisplayState"), hx::TCanCast< StageDisplayState_obj >,sStaticFields,sMemberFields,
