...
::openfl::display::GradientType GradientType_obj::LINEAR;

::openfl::display::GradientType GradientType_obj::RADIAL;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl.display.GradientType"), hx::TCanCast< GradientType_obj >,sStaticFields,sMemberFields,
