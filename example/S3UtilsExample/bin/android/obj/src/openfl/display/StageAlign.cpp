...
::openfl::display::StageAlign StageAlign_obj::BOTTOM;

::openfl::display::StageAlign StageAlign_obj::BOTTOM_LEFT;

::openfl::display::StageAlign StageAlign_obj::BOTTOM_RIGHT;

::openfl::display::StageAlign StageAlign_obj::LEFT;

::openfl::display::StageAlign StageAlign_obj::RIGHT;

::openfl::display::StageAlign StageAlign_obj::TOP;

::openfl::display::StageAlign StageAlign_obj::TOP_LEFT;

::openfl::display::StageAlign StageAlign_obj::TOP_RIGHT;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl.display.StageAlign"), hx::TCanCast< StageAlign_obj >,sStaticFields,sMemberFields,
