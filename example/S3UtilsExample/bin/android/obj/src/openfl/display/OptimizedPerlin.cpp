...
{
HX_STACK_FRAME("openfl.display.OptimizedPerlin","new",0x27f55323,"openfl.display.OptimizedPerlin.new","openfl/display/BitmapData.hx",838,0xdd12d5b9)
HX_STACK_THIS(this)
...
Void OptimizedPerlin_obj::fill( ::openfl::display::BitmapData bitmap,Float _x,Float _y,Float _z,Dynamic _){
{
		HX_STACK_FRAME("openfl.display.OptimizedPerlin","fill",0xc96cb660,"openfl.display.OptimizedPerlin.fill","openfl/display/BitmapData.hx",848,0xdd12d5b9)
		HX_STACK_THIS(this)
		...
		HX_STACK_LINE(859)
		Array< int > p = ::openfl::display::OptimizedPerlin_obj::P;		HX_STACK_VAR(p,"p");
		HX_STACK_LINE(860)
							...
							while((true)){
								...
								struct _Function_7_1{
									inline static Float Block( int &hash,Float &x1,Float &y1){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/display/BitmapData.hx",911,0xdd12d5b9)
										{
											HX_STACK_LINE(911)
								...
								struct _Function_7_3{
									inline static Float Block( int &hash,Float &x,Float &y1){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/display/BitmapData.hx",914,0xdd12d5b9)
										{
											HX_STACK_LINE(914)
								...
								struct _Function_7_5{
									inline static Float Block( int &hash,Float &x1,Float &y){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/display/BitmapData.hx",917,0xdd12d5b9)
										{
											HX_STACK_LINE(917)
								...
								struct _Function_7_7{
									inline static Float Block( int &hash,Float &x,Float &y){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/display/BitmapData.hx",920,0xdd12d5b9)
										{
											HX_STACK_LINE(920)
								...
								struct _Function_7_9{
									inline static Float Block( int &hash,Float &x1,Float &y1){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/display/BitmapData.hx",923,0xdd12d5b9)
										{
											HX_STACK_LINE(923)
											return (  (((hash < (int)8))) ? Float(x1) : Float(y1) );
										}
								...
								struct _Function_7_11{
									inline static Float Block( int &hash,Float &x,Float &y1){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/display/BitmapData.hx",926,0xdd12d5b9)
										{
											HX_STACK_LINE(926)
											return (  (((hash < (int)8))) ? Float(x) : Float(y1) );
										}
								...
								struct _Function_7_13{
									inline static Float Block( int &hash,Float &x1,Float &y){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/display/BitmapData.hx",929,0xdd12d5b9)
										{
											HX_STACK_LINE(929)
											return (  (((hash < (int)8))) ? Float(x1) : Float(y) );
										}
								...
								struct _Function_7_15{
									inline static Float Block( int &hash,Float &x,Float &y){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/display/BitmapData.hx",932,0xdd12d5b9)
										{
											HX_STACK_LINE(932)
											return (  (((hash < (int)8))) ? Float(x) : Float(y) );
										}
...
{
		HX_STACK_FRAME("openfl.display.OptimizedPerlin","octFreqPers",0x18521c91,"openfl.display.OptimizedPerlin.octFreqPers","openfl/display/BitmapData.hx",962,0xdd12d5b9)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl.display.OptimizedPerlin","seedOffset",0xacaf6781,"openfl.display.OptimizedPerlin.seedOffset","openfl/display/BitmapData.hx",985,0xdd12d5b9)
		HX_STACK_THIS(this)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl.display.OptimizedPerlin"), hx::TCanCast< OptimizedPerlin_obj> ,sStaticFields,sMemberFields,
