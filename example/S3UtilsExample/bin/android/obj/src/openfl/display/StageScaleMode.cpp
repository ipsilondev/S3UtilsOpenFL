...
::openfl::display::StageScaleMode StageScaleMode_obj::EXACT_FIT;

::openfl::display::StageScaleMode StageScaleMode_obj::NO_BORDER;

::openfl::display::StageScaleMode StageScaleMode_obj::NO_SCALE;

::openfl::display::StageScaleMode StageScaleMode_obj::SHOW_ALL;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl.display.StageScaleMode"), hx::TCanCast< StageScaleMode_obj >,sStaticFields,sMemberFields,
