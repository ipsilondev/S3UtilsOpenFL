...
::openfl::display::InterpolationMethod InterpolationMethod_obj::LINEAR_RGB;

::openfl::display::InterpolationMethod InterpolationMethod_obj::RGB;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl.display.InterpolationMethod"), hx::TCanCast< InterpolationMethod_obj >,sStaticFields,sMemberFields,
