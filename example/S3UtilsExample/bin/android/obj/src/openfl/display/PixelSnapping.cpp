...
::openfl::display::PixelSnapping PixelSnapping_obj::ALWAYS;

::openfl::display::PixelSnapping PixelSnapping_obj::AUTO;

::openfl::display::PixelSnapping PixelSnapping_obj::NEVER;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl.display.PixelSnapping"), hx::TCanCast< PixelSnapping_obj >,sStaticFields,sMemberFields,
