...
{
HX_STACK_FRAME("openfl.display.MovieClip","new",0xe16984e8,"openfl.display.MovieClip.new","openfl/display/MovieClip.hx",22,0x2b84738a)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(24)
	super::__construct();
...
{
		HX_STACK_FRAME("openfl.display.MovieClip","gotoAndPlay",0x3bade190,"openfl.display.MovieClip.gotoAndPlay","openfl/display/MovieClip.hx",35,0x2b84738a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl.display.MovieClip","gotoAndStop",0x3dafa39e,"openfl.display.MovieClip.gotoAndStop","openfl/display/MovieClip.hx",42,0x2b84738a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(frame,"frame")
		HX_STACK_ARG(scene,"scene")
	}
...
{
		HX_STACK_FRAME("openfl.display.MovieClip","nextFrame",0x3b845cc2,"openfl.display.MovieClip.nextFrame","openfl/display/MovieClip.hx",49,0x2b84738a)
		HX_STACK_THIS(this)
	}
return null();
}
...
::String MovieClip_obj::__getType( ){
	HX_STACK_FRAME("openfl.display.MovieClip","__getType",0x2e95bdd8,"openfl.display.MovieClip.__getType","openfl/display/MovieClip.hx",58,0x2b84738a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(58)
...
{
		HX_STACK_FRAME("openfl.display.MovieClip","play",0x5c42706c,"openfl.display.MovieClip.play","openfl/display/MovieClip.hx",63,0x2b84738a)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("openfl.display.MovieClip","prevFrame",0x7f95e2c2,"openfl.display.MovieClip.prevFrame","openfl/display/MovieClip.hx",70,0x2b84738a)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("openfl.display.MovieClip","stop",0x5e44327a,"openfl.display.MovieClip.stop","openfl/display/MovieClip.hx",77,0x2b84738a)
		HX_STACK_THIS(this)
	}
return null();
}
...
int MovieClip_obj::get_currentFrame( ){
	HX_STACK_FRAME("openfl.display.MovieClip","get_currentFrame",0xf2ac6035,"openfl.display.MovieClip.get_currentFrame","openfl/display/MovieClip.hx",91,0x2b84738a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(91)
...
::String MovieClip_obj::get_currentFrameLabel( ){
	HX_STACK_FRAME("openfl.display.MovieClip","get_currentFrameLabel",0x543e3d7f,"openfl.display.MovieClip.get_currentFrameLabel","openfl/display/MovieClip.hx",92,0x2b84738a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(92)
...
::String MovieClip_obj::get_currentLabel( ){
	HX_STACK_FRAME("openfl.display.MovieClip","get_currentLabel",0x5bd7f5fc,"openfl.display.MovieClip.get_currentLabel","openfl/display/MovieClip.hx",93,0x2b84738a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(93)
...
Array< ::Dynamic > MovieClip_obj::get_currentLabels( ){
	HX_STACK_FRAME("openfl.display.MovieClip","get_currentLabels",0x011f46f7,"openfl.display.MovieClip.get_currentLabels","openfl/display/MovieClip.hx",94,0x2b84738a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(94)
...
int MovieClip_obj::get_framesLoaded( ){
	HX_STACK_FRAME("openfl.display.MovieClip","get_framesLoaded",0xb37eaf4c,"openfl.display.MovieClip.get_framesLoaded","openfl/display/MovieClip.hx",95,0x2b84738a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(95)
...
int MovieClip_obj::get_totalFrames( ){
	HX_STACK_FRAME("openfl.display.MovieClip","get_totalFrames",0x46b3baa9,"openfl.display.MovieClip.get_totalFrames","openfl/display/MovieClip.hx",96,0x2b84738a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(96)
	return this->__totalFrames;
}
