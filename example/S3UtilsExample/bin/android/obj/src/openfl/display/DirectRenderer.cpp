...
::String type = __o_type.Default(HX_CSTRING("DirectRenderer"));
{
	...
	HX_STACK_LINE(17)
	this->addEventListener(::openfl::events::Event_obj::ADDED_TO_STAGE, Dynamic(new _Function_1_1(_g)),null(),null(),null());
	...
	HX_STACK_LINE(18)
	this->addEventListener(::openfl::events::Event_obj::REMOVED_FROM_STAGE, Dynamic(new _Function_1_2(_g)),null(),null(),null());
}
;
	return null();
}
...
Void DirectRenderer_obj::__onRender( Dynamic rect){
{
		...
		if (((this->render_dyn() != null()))){
			HX_STACK_LINE(32)
			::openfl::geom::Rectangle _g = ::openfl::geom::Rectangle_obj::__new(rect->__Field(HX_CSTRING("x"),true),rect->__Field(HX_CSTRING("y"),true),rect->__Field(HX_CSTRING("width"),true),rect->__Field(HX_CSTRING("height"),true));		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(32)
			this->render(_g);
		}
	}
...
{
	lime_direct_renderer_create= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_direct_renderer_create"),(int)0);
	lime_direct_renderer_set= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_direct_renderer_set"),(int)2);
}
