...
::openfl::display::CapsStyle CapsStyle_obj::NONE;

::openfl::display::CapsStyle CapsStyle_obj::ROUND;

::openfl::display::CapsStyle CapsStyle_obj::SQUARE;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl.display.CapsStyle"), hx::TCanCast< CapsStyle_obj >,sStaticFields,sMemberFields,
