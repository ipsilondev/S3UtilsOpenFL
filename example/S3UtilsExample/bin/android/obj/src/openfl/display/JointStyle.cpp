...
::openfl::display::JointStyle JointStyle_obj::BEVEL;

::openfl::display::JointStyle JointStyle_obj::MITER;

::openfl::display::JointStyle JointStyle_obj::ROUND;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl.display.JointStyle"), hx::TCanCast< JointStyle_obj >,sStaticFields,sMemberFields,
