...
void ManagedStage_obj::__boot()
{
	...
	lime_managed_stage_create= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_managed_stage_create"),(int)3);
	lime_managed_stage_pump_event= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_managed_stage_pump_event"),(int)2);
}
