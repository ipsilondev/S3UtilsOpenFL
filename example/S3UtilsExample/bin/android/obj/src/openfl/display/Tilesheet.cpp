...
int Tilesheet_obj::addTileRect( ::openfl::geom::Rectangle rectangle,::openfl::geom::Point centerPoint){
	...
	if (((centerPoint == null()))){
		...
		HX_STACK_LINE(55)
		::openfl::geom::Point _g = ::openfl::geom::Point_obj::__new((Float(centerPoint->x) / Float(rectangle->width)),(Float(centerPoint->y) / Float(rectangle->height)));		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(55)
	...
	HX_STACK_LINE(56)
	::openfl::geom::Rectangle _g9 = ::openfl::geom::Rectangle_obj::__new(_g2,_g4,_g6,_g8);		HX_STACK_VAR(_g9,"_g9");
	HX_STACK_LINE(56)
...
::openfl::geom::Point Tilesheet_obj::getTileCenter( int index){
	...
	HX_STACK_LINE(70)
	return this->_tilePoints->__get(index).StaticCast< ::openfl::geom::Point >();
}
...
::openfl::geom::Rectangle Tilesheet_obj::getTileRect( int index){
	...
	HX_STACK_ARG(index,"index")
	HX_STACK_LINE(74)
	return this->_tiles->__get(index).StaticCast< ::openfl::geom::Rectangle >();
}
...
::openfl::geom::Rectangle Tilesheet_obj::getTileUVs( int index){
	...
	HX_STACK_ARG(index,"index")
	HX_STACK_LINE(78)
	return this->_tileUVs->__get(index).StaticCast< ::openfl::geom::Rectangle >();
}
...
::openfl::geom::Point Tilesheet_obj::defaultRatio;
...
Dynamic Tilesheet_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 11:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"defaultRatio") ) { defaultRatio=inValue.Cast< ::openfl::geom::Point >(); return inValue; }
...
void Tilesheet_obj::__boot()
{
	...
	defaultRatio= ::openfl::geom::Point_obj::__new((int)0,(int)0);
	lime_tilesheet_create= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_tilesheet_create"),(int)1);
	lime_tilesheet_add_rect= ::openfl::Lib_obj::load(HX_CSTRING("lime"),HX_CSTRING("lime_tilesheet_add_rect"),(int)3);
}
