...
{
HX_STACK_FRAME("openfl.display.IGraphicsData","new",0x6431bee6,"openfl.display.IGraphicsData.new","openfl/display/IGraphicsData.hx",12,0xd0292c4c)
HX_STACK_THIS(this)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl.display.IGraphicsData"), hx::TCanCast< IGraphicsData_obj> ,sStaticFields,sMemberFields,
