...
::openfl::media::InternalAudioType InternalAudioType_obj::MUSIC;

::openfl::media::InternalAudioType InternalAudioType_obj::SOUND;

::openfl::media::InternalAudioType InternalAudioType_obj::UNKNOWN;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("openfl.media.InternalAudioType"), hx::TCanCast< InternalAudioType_obj >,sStaticFields,sMemberFields,
