...
Array< ::Dynamic > Matrix3D_obj::decompose( ){
	...
	HX_STACK_LINE(248)
	Float _g1 = ::Math_obj::sqrt((((mr->__get((int)0) * mr->__get((int)0)) + (mr->__get((int)1) * mr->__get((int)1))) + (mr->__get((int)2) * mr->__get((int)2))));		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(248)
	scale->x = _g1;
	HX_STACK_LINE(249)
	Float _g2 = ::Math_obj::sqrt((((mr->__get((int)4) * mr->__get((int)4)) + (mr->__get((int)5) * mr->__get((int)5))) + (mr->__get((int)6) * mr->__get((int)6))));		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(249)
	scale->y = _g2;
	HX_STACK_LINE(250)
	Float _g3 = ::Math_obj::sqrt((((mr->__get((int)8) * mr->__get((int)8)) + (mr->__get((int)9) * mr->__get((int)9))) + (mr->__get((int)10) * mr->__get((int)10))));		HX_STACK_VAR(_g3,"_g3");
	HX_STACK_LINE(250)
	scale->z = _g3;
	HX_STACK_LINE(252)
	...
	HX_STACK_LINE(269)
	Float _g4 = ::Math_obj::asin(-(mr->__get((int)2)));		HX_STACK_VAR(_g4,"_g4");
	HX_STACK_LINE(269)
	rot->y = _g4;
	HX_STACK_LINE(270)
	...
	if (((C > (int)0))){
		HX_STACK_LINE(274)
		Float _g5 = ::Math_obj::atan2(mr->__get((int)6),mr->__get((int)10));		HX_STACK_VAR(_g5,"_g5");
		HX_STACK_LINE(274)
		rot->x = _g5;
		HX_STACK_LINE(275)
		Float _g6 = ::Math_obj::atan2(mr->__get((int)1),mr->__get((int)0));		HX_STACK_VAR(_g6,"_g6");
		HX_STACK_LINE(275)
		rot->z = _g6;
	}
	else{
		...
		rot->z = (int)0;
		HX_STACK_LINE(280)
		Float _g7 = ::Math_obj::atan2(mr->__get((int)4),mr->__get((int)5));		HX_STACK_VAR(_g7,"_g7");
		HX_STACK_LINE(280)
		rot->x = _g7;
	}
	HX_STACK_LINE(284)
...
bool Matrix3D_obj::recompose( Array< ::Dynamic > components){
	...
	this->identity();
	HX_STACK_LINE(561)
	this->appendScale(components->__get((int)2).StaticCast< ::openfl::geom::Vector3D >()->x,components->__get((int)2).StaticCast< ::openfl::geom::Vector3D >()->y,components->__get((int)2).StaticCast< ::openfl::geom::Vector3D >()->z);
	HX_STACK_LINE(563)
	Float angle;		HX_STACK_VAR(angle,"angle");
	HX_STACK_LINE(564)
	angle = -(components->__get((int)1).StaticCast< ::openfl::geom::Vector3D >()->x);
	HX_STACK_LINE(565)
	...
	this->append(_g5);
	HX_STACK_LINE(566)
	angle = -(components->__get((int)1).StaticCast< ::openfl::geom::Vector3D >()->y);
	HX_STACK_LINE(567)
	...
	this->append(_g11);
	HX_STACK_LINE(568)
	angle = -(components->__get((int)1).StaticCast< ::openfl::geom::Vector3D >()->z);
	HX_STACK_LINE(569)
	...
	this->append(_g17);
	HX_STACK_LINE(571)
	this->set_position(components->__get((int)0).StaticCast< ::openfl::geom::Vector3D >());
	HX_STACK_LINE(572)
	this->rawData[(int)15] = (int)1;
	HX_STACK_LINE(574)
	return true;
...
Float Matrix3D_obj::get_determinant( ){
	HX_STACK_FRAME("openfl.geom.Matrix3D","get_determinant",0x5f71b8a4,"openfl.geom.Matrix3D.get_determinant","openfl/geom/Matrix3D.hx",640,0x3acce238)
	HX_STACK_THIS(this)
	HX_STACK_LINE(640)
...
::openfl::geom::Vector3D Matrix3D_obj::get_position( ){
	HX_STACK_FRAME("openfl.geom.Matrix3D","get_position",0x1555563a,"openfl.geom.Matrix3D.get_position","openfl/geom/Matrix3D.hx",652,0x3acce238)
	HX_STACK_THIS(this)
	HX_STACK_LINE(652)
